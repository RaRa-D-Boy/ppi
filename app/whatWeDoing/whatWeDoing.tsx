...
export default function WhatWeDoing() {
  return (
    <section className="relative  overflow-hidden py-12 px-6 md:p-12 lg:p-24" id="charity">
      <img
          ...
          <div className="flex flex-wrap -mx-4 mb-18 items-center">
            <div className="w-full px-4 mb-12 lg:mb-0">
              <div>
                ...
                <h1 className="text-3xl md:text-5xl lg:text-7xl leading-tight text-gray-900 font-bold mb-8">
