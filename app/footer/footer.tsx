      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap items-center justify-between -mx-4 pb-12">
          <div className="hidden lg:block w-full lg:w-auto px-4 mb-2 lg:mb-0">
            ...
            <p className="text-sm text-gray-500">Offices in USA, UK and Ghana</p>
          </div>
          <div className="w-full lg:w-auto px-4 flex justify-center lg:justify-end">
            <ul className="flex flex-nowrap items-center -mb-2 text-sm">
              <li className="mx-2 mb-2 sm:mr-6 lg:mr-16">
                <span className="font-heading text-gray-500 hover:text-black">
                  info@pathwayspioneersinitiative.org
                </span>
              </li>
              <li className="mx-2 mb-2 sm:mr-6 lg:mr-16">
                <span className="font-heading text-gray-500 hover:text-black">
              ...
              <li className="mx-2 mb-2 sm:mr-6 lg:mr-16">
                {" "}
                <span className="mt-6 sm:mt-0 text-gray-500 text-sm ">
                  2025 © PPI
                </span>
              </li>
